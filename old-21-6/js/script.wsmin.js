...
function Grow() {
    ...
    this.desktop = {
        ...
        screen1: function () {
            ...
            screen1
                .fromTo("#line1_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 50000 })                
        ...
        screen2: function () {
            ...
            screen2
                .fromTo("#line2_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 500 })
                .fromTo("#line2_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 1000 });
            screen2.cleanUpObjects = ["#line2_2"];
            screen2.fromTo(".screen2", {}, { duration: 1000 });
            self.desktop.animations[1] = screen2;
            return screen2;
        },
        screen3: function () {
            var screen3 = new TimelineMax();
            screen3
                .fromTo("#line3_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 355 })
                .fromTo("#line3_2",{ drawSVG: "0%"}, { drawSVG: "100%", duration: 450 });
            screen3.cleanUpObjects = ["#line3_2"];
            screen3.fromTo(".screen3", {}, { duration: 2000 });
            self.desktop.animations[1] = screen3;
            return screen3;
        },
        screen4: function () {
            var screen4 = new TimelineMax();
            screen4
                .fromTo("#line4_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 150 })                
            screen4.cleanUpObjects = ["#line4_1"];
            screen4.fromTo(".screen4",5,{}, { duration: 200 });
            self.desktop.animations[0] = screen4;
            return screen4;
        },
        ...
        registerAnimations: function () {
            ...
            screen1.duration(700);
            screen2.duration(1000);
            screen3.duration(1200);
            screen4.duration(2500);
            screen5.duration(5000);
