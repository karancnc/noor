window.lazyLoadOptions = { elements_selector: ".lazy", threshold: 1101 };
    ...
    this.desktop = {
        ...
        createScrollTween: function () {
            ...
            scrollTweenObject.to(self.desktop.bee, {
                motionPath: { path: "#scrollPath", align: "#scrollPath", autoRotate: !0, start: 0, end: 1 },
                ease: "linear",
                onUpdate: function () {
        ...
        screen1: function () {
            ...
            screen1
                .fromTo("#line1_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 500 });            
        ...
        screen2: function () {
            ...
            screen2
                .fromTo("#line2_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 1500 })
                .fromTo("#line2_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 2000 });

            //screen2.cleanUpObjects = ["#line2_1"]; 
        ...
        screen3: function () {
            ...
            this.cleanUpObjects = [];       
            screen3
                .fromTo("#line3_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 500 })
                .fromTo("#line3_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 1000});
            screen3.fromTo(".screen3", {}, { duration:450});
        ...
        screen4: function () {
            ...
            //this.cleanUpObjects = [];  
            screen4
                .fromTo("#line4_1", { drawSVG: "0%"}, { drawSVG: "100%", duration:1500});            
        ...
        screen5: function () {
            ...
            screen5
                .fromTo("#line5_1", { drawSVG: "0%" }, { drawSVG: "100%", duration:1500});
            //screen5.cleanUpObjects = ["#line5_1"]; 
        ...
        screen6: function () {
            ...
            screen6.fromTo("#line6_1", { drawSVG: "0%" }, { drawSVG: "100%", duration:65 },50);
            screen6.cleanUpObjects = [];    
            self.desktop.animations[6] = screen6;
            return screen6;
        },      
        screen7: function () {
            var screen7 = new TimelineMax();        
            screen7.fromTo("#line7_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 120 },40);
            screen7.cleanUpObjects = ["#line7_1"];       
        ...
        screen8: function () {
            ...
            screen8
                .fromTo("#line8_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 800 },150);
            screen8.cleanUpObjects = ["#line8_1"];       
        ...
        screen9: function () {
            ...
            screen9
                .fromTo("#line9_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 550 },100);
        ...
        screen10: function () {
            ...
            screen10
                .fromTo("#line10_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 150 })
                .fromTo("#line10_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 300 });

            screen10.cleanUpObjects = ["#line10_1"];       
        ...
        screen11: function () {
            ...
            screen11
                .fromTo("#line11_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 10 });
            screen11.cleanUpObjects = [];       
            var criteria = document.querySelectorAll(".screen11__text .col");
            var criteriaDuration = 3 / (criteria.length * 10);
            criteria.forEach(function (each, index) {
                var round_line = each.querySelector(".screen11__text .col .round");
                screen11.cleanUpObjects.push(round_line);
                screen11
                    .fromTo(round_line, { opacity: 0 }, { opacity: 1, duration: criteriaDuration });
            });
            //screen11.fromTo(".screen11", {}, { duration: 0 });
        ...
        screen12: function () {
            ...
            screen12
                .fromTo("#line12_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 250 },250);
            screen12.cleanUpObjects = ["#line12_1"];  
        ...
        screen13: function () {
            ...
            screen13
                .fromTo("#line13_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 120 },90)
                .fromTo("#line13_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 140 },85);
            screen13.cleanUpObjects = ["#line13_1"];       
        ...
        screen14: function () {
            ...
            this.cleanUpObjects = [];       
            screen14
                .fromTo("#line14_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 150 },232)
                .fromTo("#line14_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 250 },255)
                .fromTo("#line14_3", { drawSVG: "0%" }, { drawSVG: "100%", duration: 150 },262);

            screen14.cleanUpObjects = ["#line14_1"];       
            var criteria = document.querySelectorAll(".team-member-wrap .team-member");
            var criteriaDuration = 150 / (criteria.length * 10);
            criteria.forEach(function (each, index) {
                var round_line = each.querySelector(".team-member-wrap .team-member");
                screen14.cleanUpObjects.push(round_line);
                screen14
                    .fromTo(round_line, { opacity: 0 }, { opacity: 1, duration: criteriaDuration });
            });

            screen14.fromTo(".screen14", {}, { duration: 450 });
        ...
        screen15: function () {
            ...
            screen15
                .fromTo("#line15_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 150 },252);
            screen15.cleanUpObjects = ["#line15_1"];       
            self.desktop.animations[15] = screen15;
            return screen15;
        },      
        screen16: function () {
            var screen16 = new TimelineMax();                  
            screen16
                .fromTo("#line16_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 250 })
                .fromTo("#line16_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 350 });
            screen16.cleanUpObjects = ["#line16_1"];
            self.desktop.animations[16] = screen16;
            return screen16;
        },      
        screen17: function () {
            var screen17 = new TimelineMax();               
            screen17
                .fromTo("#line17_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 150 })
                .fromTo("#line17_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 170 })
                .fromTo("#line17_4", { drawSVG: "0%", fill: "#2F76F6" }, { drawSVG: "100%", fill: "#ffbd62", duration: 75 });
            screen17.cleanUpObjects = ["#line17_1"];   
            self.desktop.animations[17] = screen17;
            return screen17;
        },        
        screen18: function () {
            var screen18 = new TimelineMax();            
            screen18
                .fromTo("#line18_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 150 })
                .fromTo("#line18_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 80 })
                .fromTo("#line18_4", { drawSVG: "0%", fill: "#2F76F6" }, { drawSVG: "100%", fill: "#ffbd62", duration: 85 });
            screen18.cleanUpObjects = ["#line18_1"];       
            self.desktop.animations[18] = screen18;
            return screen18;
        },       
        screen19: function () {
            var screen19 = new TimelineMax();            
            screen19
                .fromTo("#line19_1", { drawSVG: "0%" }, { drawSVG: "100%", duration: 90 })
                .fromTo("#line19_2", { drawSVG: "0%" }, { drawSVG: "100%", duration: 110 })
                .fromTo("#line19_4", { drawSVG: "0%", fill: "#2F76F6" }, { drawSVG: "100%", fill: "#ffbd62", duration: 150 });
            screen19.cleanUpObjects = ["#line19_1"];       
            self.desktop.animations[19] = screen19;
            return screen19;
        },
        registerAnimations: function () {
            ...
            var screen16 = self.desktop.screen16();
            var screen17 = self.desktop.screen17();
            var screen18 = self.desktop.screen18();
            var screen19 = self.desktop.screen19();
            screen1.duration(350);
            screen2.duration(400);
            screen3.duration(1200);
            screen4.duration(1500);
            screen5.duration(800);
            screen6.duration(400);
            screen7.duration(450);
            screen8.duration(800);
            screen9.duration(1250);
            screen10.duration(1300);
            screen11.duration(350);
            screen12.duration(450);
            screen13.duration(400);
            screen14.duration(1350);
            screen15.duration(1400);
            screen16.duration(1100);
            screen17.duration(350);
            screen18.duration(400);
            screen19.duration(460);
            var buffer = new TimelineMax();
            buffer.fromTo(".screen19", {}, { duration: 1000});
            buffer.duration(200);
            ...
            master.add(screen16, "screen16");
            master.add(screen17, "screen17");
            master.add(screen18, "screen18");
            master.add(screen19, "screen19");
    ...
    (this.mobile = {
        ...
        screen4Animations: function () {
            ...
            if (kpiOne) {
                ...
                screen4
                    ...
                    .fromTo(fillPaths, { fill: "#ffffff" }, { fill: "#2f76f6", duration: 100 }, "kpiOne")
            ...
            if (kpiTwo) {
                ...
                screen4
                    .add("kpiTwo")
                    .fromTo(kpiStrokePaths, { drawSVG: "0%" }, { drawSVG: "100%", duration: 100 })
                    .fromTo(fillPaths, { fill: "#ffffff" }, { fill: "#2f76f6", duration: 100 }, "kpiTwo")
            ...
            if (kpiThree) {
                ...
                screen4
                    .add("kpiThree")
                    .fromTo(kpiStrokePaths, { drawSVG: "0%" }, { drawSVG: "100%", duration: 100 })
                    .fromTo(fillPaths, { fill: "#ffffff" }, { fill: "#2f76f6", duration: 100 }, "kpiThree")
        ...
        screen9Animations: function () {
            ...
            kpisList.forEach(function (kpi, index) {
                ...
                var fillPaths = kpi.querySelectorAll('.screen9__kpi__icon [fill="#fff"], .screen9__kpi__icon [fill="#ffffff"], .screen9__kpi__icon [fill="#2f76f6"]');
        ...
        screen11Animations: function () {
            ...
            kpisList.forEach(function (kpi, index) {
                ...
                var fillPathsBlue = kpi.querySelectorAll('.screen11__kpi__icon [fill="#2f76f6"]');
                ...
                screen11
                    ...
                    .fromTo(fillPathsBlue, { fill: "#ffffff" }, { fill: "#2f76f6", duration: 25 }, kpiLabel)
        ...
        screen12Animations: function () {
            ...
            kpisList.forEach(function (kpi, index) {
                ...
                var fillPathsBlue = kpi.querySelectorAll('.screen12__kpi__icon [fill="#2f76f6"]');
                ...
                screen12
                    ...
                    .fromTo(kpiPaths, { drawSVG: "0%" }, { drawSVG: "100%", duration: 25 })
                    .fromTo(fillPathsBlue, { fill: "#ffffff" }, { fill: "#2f76f6", duration: 25 }, kpiLabel)
                    .fromTo(fillPathsWhite, { fill: "#2f76f6" }, { fill: "#ffffff", duration: 25 }, kpiLabel)
                    .fromTo(lineSelector, { drawSVG: "0%" }, { drawSVG: "100%", duration: lineDuration });
                if (index == kpisList.length - 1) {
                    screen12.fromTo(lineSelector + "_fill", { fill: "#2f76f6" }, { fill: "#ffbd62", duration: 25 }, "-=50");
                }
                kpiPaths.forEach(function (item, index) {
        ...
        screen15Animations: function () {
            ...
            .fromTo("#line15_4", { drawSVG: "0%", fill: "#2F76F6" }, { drawSVG: "100%", fill: "#ffbd62", duration: 200 })
